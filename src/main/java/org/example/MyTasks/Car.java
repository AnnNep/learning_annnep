...
//Поля можем считать ИНКАПСУЛЯЦИЕЙ
    ...
    //контракт = любой метод, конструктор = способ взаимодействия с твоим кодом
    //когда ты пишешь абстрактный метод в абстрактном классе или интерфейсе - ты создаешь контракт для наследующего кода
